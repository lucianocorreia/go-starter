...
func Set(ctx echo.Context, typ FlashType, message string) {
...
// Errors will logged and not returned
func Get(ctx echo.Context, typ FlashType) []string {
	var msgs []string
